...
// 1. Uses window.__ENV__.VITE_API_URL injected at runtime (Docker)
// 2. Falls back to VITE_API_URL from build time
// 3. Falls back to localhost:8000 (backend server port)
const API_BASE_URL = window.__ENV__?.VITE_API_URL || import.meta.env.VITE_API_URL || 'http://localhost:8000'
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <div className="flex space-x-4 border-b border-indigo-200">
            <button
              ...
              className={`px-6 py-3 font-semibold ${activeTab === 'upload'
        ...
        {activeTab === 'upload' && (
          <div className="bg-white rounded-lg shadow-xl p-8 mb-8">
            ...
            {currentResult && (
              <div className="mt-8 bg-gray-50 rounded-lg p-6" data-testid="extraction-result">
        ...
        {activeTab === 'results' && (
          <div className="bg-white rounded-lg shadow-xl p-8">
            ...
            {records.length === 0 ? (
              <p className="text-gray-600 text-center py-8" data-testid="empty-records-message">
                No records yet. Upload a form to get started!
              </p>
            ) : (
              <div className="space-y-4" data-testid="records-list">
                {records.map((record) => (
                  <div
                    key={record.id}
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <div className="space-x-2">
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700"
                          data-testid={`download-json-${record.id}`}
                        >
                          JSON
                        </button>
                        <button
                          ...
                          className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700"
                          data-testid={`download-csv-${record.id}`}
                        >
                          CSV
                        </button>
                        <button
                    ...
                    {editingRecord?.id === record.id ? (
                      <div className="bg-yellow-50 p-4 rounded" data-testid="edit-mode">
